                    ...
                    Container(
                      ...
                      child: MaterialButton(
                                                ...
                                                color: Theme.of(context)
                                                    .accentColor,
                                                elevation: 3,
                        onPressed: () {totalPayable = widget.total*0.1;
                        print(totalPayable.toStringAsFixed(2));},
  ...
  void _handleRadioValueChange2(int value) {
    ...
    setState(() {
      ...
      switch (_radioValue) {
        case 2:
          _payOption = "Deposit";
          totalPayable = widget.total*0.1;
          break;
        case 3:
        _payOption = "Full";
        totalPayable = widget.total;
          break;
      }
    });
  }
